<?php
namespace OnyxRestTest\Controller;

use OnyxRestTest\Bootstrap;
use OnyxRest\Controller\OnyxRestController;
...
class OnyxRestControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->controller = new OnyxRestController();
